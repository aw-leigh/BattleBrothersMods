this.named_shield <- this.inherit("scripts/items/shields/shield", {
	...
	{
		this.m.Condition = this.Math.round(this.m.Condition * this.Math.rand(150, 200) * 0.01) * 1.0;
		this.m.ConditionMax = this.m.Condition;				
        
        local available = [];
		available.push(function ( _i )
		{
			_i.m.MeleeDefense = this.Math.round(_i.m.MeleeDefense * this.Math.rand(150, 175) * 0.01);
		});
		available.push(function ( _i )
		{
			_i.m.RangedDefense = this.Math.round(_i.m.RangedDefense * this.Math.rand(150, 175) * 0.01);
		});
		available.push(function ( _i )
		{
		...
		available.push(function ( _i )
		{
			_i.m.StaminaModifier = this.Math.round(_i.m.StaminaModifier * this.Math.rand(50, 70) * 0.01);
		});
